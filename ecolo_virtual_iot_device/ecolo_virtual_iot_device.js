...
const publishAsync = (
  ...
  // [Modify Streaming interval]  
  let publishDelayMs = 1000;
  if (shouldBackoff) {
...
// [Modify Message Body]  
  setTimeout(() => {
    ...
    let globalActivePower = [4.216, 5.36, 5.374, 5.388, 3.666, 3.52]
    let subMetering1 = [0, 0, 0, 0, 0, 0]
    let subMetering2 = [1, 1, 2, 1, 1, 2]
    let subMetering3 = [17, 16, 17, 17, 17, 17]
    let randomIndex = Math.floor(Math.random() * 5);    
    const payload = `{'globalActivePower': ${globalActivePower[randomIndex]}, 'subMetering1': ${subMetering1[randomIndex]}, 'subMetering2': ${subMetering2[randomIndex]}, 'subMetering3': ${subMetering3[randomIndex]}}`
